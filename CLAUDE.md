...
Recordari (api.recordar.io MCP) and Mem0 (local baseline).
...
- Comparator is Mem0 (paper baseline: 3/15). The LoCoMo "Memora only" publication rule does NOT apply here.
